...
pub mod marks {
    ...
    /// 済ませたいが、キーボードからは `###` に一打で行きたい ── Inkdrop も
...
<span style=\"color:#0E93A8\">シアン</span>。";
    ...
    fn 番号つきは番号で出る() {
        ...
        let out = to_html(&lines("3. 3 つめから\n"));
