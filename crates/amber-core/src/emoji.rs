...
//!
//! 外部から取りに行かない ── 会社の閉じた端末ではネットに出られないし、
...
//! 足りないものは OS の絵文字パレットから打てる（`.md` に入るのは同じ文字）。
//!
//! 1 つの表を 2 つの amber が読む ── デスクトップ版と iPhone で並びも名前も違う、を作らない。
...
/// **初めて開いた人が見る 24 個。**
///
/// 「最近つかったもの」の初期値でもある ── 空の一覧を見せない。
/// 選び方は「毎日の返信に要るもの」: 祝う・褒める・頼む・目印を付ける。
...
/// 送る形。デスクトップ版も iPhone もこれを一度受け取って、あとは自分で並べる。
