    ...
    vec![
        ...
        (
            ...
            vec![
                ...
                entry("Bksp", Some(Parent), "parent folder (bind `-` to it in init.lua if you want that too)", "親フォルダへ（`-` も使いたければ init.lua で割当）"),
                ...
                entry("C, Ctrl+,", None, "command palette: fuzzy-find any command", "コマンドパレット：全コマンドをあいまい検索"),
        ...
        (
            ...
            vec![
                ...
                entry("Ctrl+Enter", Some(OpenOther), "a folder → the opposite pane; a file → your own app", "フォルダは反対ペインで開く／ファイルは既定のアプリで開く"),
