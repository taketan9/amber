...
/// （Rust の 1 つ 358MB）が根に置かれていて、それを二度包み、746MB になった。
...
function main() {
    ...
    // 四、依存の在り処を Cargo に教える 1 つ。**ネットワークに出さない**ためのラベルでもある。
    const conf = [
    ...
    fs.writeFileSync(readAt, [
        ...
        '',
        '    ネットワークにつながる端末で下の 1 つを落として、この一式と一緒に USB へ入れて',
        ...
        '    そのまま進む。',
        '',
        '    Visual Studio は要りません（このインストーラに、組むのに要るものが全部入っています）。',
