...
core は読んだときの文字コード・BOM・改行のまま書き戻すが、**デスクトップ版と iPhone を
...
print("よそから来た形のノートを3 つ置きました")

# **大きいノート。** 一万行 ── 画面のビルドし直しと保存が保つか（依頼 431）。
...
# **使われていない画像**（依頼 449）。1 つは本文から指し、1 つは
